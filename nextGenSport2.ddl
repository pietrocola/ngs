...
CREATE TABLE Cliente (ID varchar(255) NOT NULL, Nome varchar(255), Cognome varchar(255), Telefono int(11) NOT NULL, Email varchar(255), PRIMARY KEY (ID)) ENGINE=InnoDB;
...
CREATE TABLE Pagamento (ID int(11) NOT NULL AUTO_INCREMENT, Data date, Importo float NOT NULL, Stato tinyint(1) NOT NULL, PRIMARY KEY (ID)) ENGINE=InnoDB;
CREATE TABLE Abbonamento (ID int(11) NOT NULL AUTO_INCREMENT, ElencoAbbonamentiID int(11), PreventivoAbbonamentoID int(11), ClienteID varchar(255), PagamentoID int(11), DataInizio date, DataFine date, PRIMARY KEY (ID)) ENGINE=InnoDB;
CREATE TABLE ElencoAbbonamenti (ID int(11) NOT NULL AUTO_INCREMENT, PRIMARY KEY (ID)) ENGINE=InnoDB;
...
ALTER TABLE Abbonamento ADD INDEX FKAbbonament3917 (PagamentoID), ADD CONSTRAINT FKAbbonament3917 FOREIGN KEY (PagamentoID) REFERENCES Pagamento (ID);
...
ALTER TABLE Abbonamento ADD INDEX FKAbbonament504852 (ElencoAbbonamentiID), ADD CONSTRAINT FKAbbonament504852 FOREIGN KEY (ElencoAbbonamentiID) REFERENCES ElencoAbbonamenti (ID);
