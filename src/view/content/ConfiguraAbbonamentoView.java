...
public class ConfiguraAbbonamentoView extends Pannello{
	...
	public ConfiguraAbbonamentoView(Boolean aux){
	...
	public Pannello draw() {
		return new ConfiguraAbbonamentoView();
	}
	...
	public Pannello drawEmpty() {
		return new ConfiguraAbbonamentoView(true);
	}
}
